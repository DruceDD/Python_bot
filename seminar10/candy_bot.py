# выполнено совместно с Зевиной Еленой
        ...
        if 0 < x <= step:
            ...
            if candies <= step:
                ...
                if y > 0:
                    ...
                    if candies <= step:
                        update.message.reply_text(emoji.emojize("Игра окончена, ты победил/а! :love-you_gesture:"), reply_markup=markup)
                        return ConversationHandler.END
                else:
                    ...
                    if candies <= step:
                        update.message.reply_text(
                            emoji.emojize("Игра окончена, ты победил/а! :love-you_gesture:"),
                            reply_markup=markup)
                        return ConversationHandler.END
        else:
